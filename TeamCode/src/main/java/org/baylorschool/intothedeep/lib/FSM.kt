    ...
    fun loop(gamepad: Gamepad, rumble: Gamepad, telemetry: Telemetry) {
        when(state) {
            ...
            if (gamepad.dpad_left) {
                Global.PivotPresets.WALL_PICKUP.pos -= 3
            } else if (gamepad.dpad_right) {
                Global.PivotPresets.WALL_PICKUP.pos += 3
            }
            if (gamepad.dpad_up) {
            ...
            if (gamepad.dpad_left) {
                Global.PivotPIDConfig.target -= 6
            } else if (gamepad.dpad_right) {
                Global.PivotPIDConfig.target += 6
            }
            ...
            if (gamepad.dpad_left) {
                Global.PivotPresets.SPEC_DEPOSIT.pos -= 3
            } else if (gamepad.dpad_right) {
                Global.PivotPresets.SPEC_DEPOSIT.pos += 3
            }
            if (gamepad.y) {
            ...
            pivot.l2Hang()
            if (gamepad.dpad_left) {
                Global.PivotPresets.LOW_RUNG.pos -= 6
            } else if (gamepad.dpad_right) {
                Global.PivotPresets.LOW_RUNG.pos += 6
            }
            if (gamepad.a) {
            ...
            pivot.l2HangRetract()
            if (gamepad.dpad_left) {
                Global.PivotPresets.LOW_RUNG_RETRACT.pos -= 10
            } else if (gamepad.dpad_right) {
                Global.PivotPresets.LOW_RUNG_RETRACT.pos += 10
            }
        }
