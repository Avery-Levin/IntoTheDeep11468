...
public class LConstants {
    static {
        ...
        PinpointConstants.forwardEncoderDirection = GoBildaPinpointDriver.EncoderDirection.REVERSED; //TODO Determine the encoder direction for the final robot
        PinpointConstants.strafeEncoderDirection = GoBildaPinpointDriver.EncoderDirection.FORWARD; //TODO Determine the encoder direction for the final robot
